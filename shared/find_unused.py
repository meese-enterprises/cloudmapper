...
def find_unused_security_groups(region):
    ...
    network_interfaces = query_aws(region.account, "ec2-describe-network-interfaces", region)
    ...
    for used_sg in pyjq.all(".NetworkInterfaces[]?.Groups[].GroupId", network_interfaces):
